    ...
    <Layout>
      ...
      <Container className="grid gap-12 grid-cols-1 md:grid-cols-2">
        <div>
          ...
          <p className="mb-4">
            Creating an event on Events is a surefire way to elevate your event's success to
            unprecedented heights. From concerts to festivals, Events caters to all event types,
          ...
          <p>
            ...
            event gain momentum like never before on Events.
          </p>
        </div>
